...
public class EventLog {
	 ...
	 */
	private final LinkedList<LoggedEvent> events = new LinkedList<LoggedEvent>();
	 ...
	 * file, returns true.
	 * 
	 * @param message the string to search for
	 ...
	 * @return the first LoggedEvent which contains the given string
	 */
